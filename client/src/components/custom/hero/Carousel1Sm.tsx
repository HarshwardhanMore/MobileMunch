...
const Carousel1Sm = ({ images, headings, descriptions, interval = 5000 }: any) => {
      ...
      <div style={{ position: 'relative', overflow: 'hidden', width: "90%", height: "100%" }}>
        <div style={{ display: 'flex', transition: 'transform 1s ease-in-out', transform: `translateX(-${currentIndex * 100}%)`, height: "100%", width: "100%" }}>
          {images.map((img: any, index: any) => (
            ...
            >
              {/* <div className=' h-full w-1/2 flex flex-col items-end justify-center px-8 text-right'>
                <div className=' my-4'>
              ...
              <div className=' h-[90%] w-full flex flex-col justify-center items-center'>
                ...
                <div className=' h-full w-full flex flex-col items-end justify-center px-8 text-right'>
                  <div className=' my-4'>
        ...
        <button
          style={{ position: 'absolute', top: '25%', left: '4px', transform: 'translateY(-50%)', fontSize: '2rem', color: 'white', border: 'none', cursor: 'pointer', outline: 'none' }}
          onClick={handlePrev}
        >
          <ChevronLeft color='black'/>
        </button>
        <button
          style={{ position: 'absolute', top: '25%', right: '4px', transform: 'translateY(-50%)', fontSize: '2rem', color: 'white', border: 'none', cursor: 'pointer', outline: 'none' }}
          onClick={handleNext}
        >
